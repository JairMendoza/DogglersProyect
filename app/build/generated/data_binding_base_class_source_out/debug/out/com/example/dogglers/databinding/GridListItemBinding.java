...
public final class GridListItemBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView itemImageDog;

  private GridListItemBinding(@NonNull MaterialCardView rootView, @NonNull TextView dogAge,
      @NonNull TextView dogHobbies, @NonNull TextView dogName, @NonNull ImageView itemImageDog) {
    this.rootView = rootView;
    this.dogAge = dogAge;
    this.dogHobbies = dogHobbies;
    this.dogName = dogName;
    this.itemImageDog = itemImageDog;
  }
  ...
  public static GridListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.item_image_dog;
      ImageView itemImageDog = rootView.findViewById(id);
      if (itemImageDog == null) {
        break missingId;
      }
